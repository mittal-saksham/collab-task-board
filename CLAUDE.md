...
- ✅ **Tests + CI** — 47 tests (pytest: ordering math + auth + board access-control;
  vitest: filter/time helpers) running on GitHub Actions (`docs/LLD.md §10`).
...
`postgres:16` service). 47 tests total. Full notes in `docs/LLD.md §10`.
