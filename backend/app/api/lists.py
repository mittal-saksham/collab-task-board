...
def create_list(
    ...
    return list_crud.create_list(db, board_id=board_id, title=payload.title)
...
def update_list(
    ...
    return list_crud.update_list(db, lst, title=payload.title)
...
def move_list(
    ...
    return list_crud.move_list(db, lst, after_id=payload.after_id)
